...
//                                 <input
//                                     className="w-[32.8125rem] placeholder:text-white bg-transparent border border-[#D1D5DB]  rounded-md py-2 pl-3 pr-10 focus:outline-none"
...
//                             </svg>
//                             <svg className='absolute  top-[0.3rem] left-1 items=center' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
function Header() {
    ...
    return (
        <div>
            ...
            {/*Desktop Header */}
            <div className="flex justify-between items-center text-white font-bold mt-[-20px]">
                <div className='inline-flex items-center gap-20 '>
                    <div className='inline-flex items-center gap-6 ml-20'>
                        <a href="">
                            <img src={tv} alt="movie-icon" className='w-[3.125rem] h-[3.125rem] ' />
